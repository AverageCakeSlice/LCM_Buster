#LCM Buster - Moves LCM machines to their correct location in AD, and validates user input.

#~~~~~~~~~GLOBAL VARIABLE INITIALIZATION~~~~~~~~~#
If($newLCMComputerName -eq $null)
{
...
#The Get-VPNStatus function checks if Cisco Anyconnect is actually connected. If it is not, it will launch the anyconnect window to propt the user to login.
